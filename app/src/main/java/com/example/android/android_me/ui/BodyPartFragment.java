...
public class BodyPartFragment extends Fragment {
    ...
    public static final String SAVE_INSTANCE_LIST = "SAVE_INSTANCE_LIST";
    public static final String SAVE_INSTANCE_INDEX = "SAVE_INSTANCE_INDEX";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            mImageIds = savedInstanceState.getIntegerArrayList(SAVE_INSTANCE_LIST);
            mListIndex = savedInstanceState.getInt(SAVE_INSTANCE_INDEX);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(SAVE_INSTANCE_LIST, ((ArrayList<Integer>) mImageIds));
        outState.putInt(SAVE_INSTANCE_INDEX, mListIndex);
